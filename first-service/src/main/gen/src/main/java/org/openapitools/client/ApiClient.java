...
public class ApiClient {
    ...
    private String basePath = "http://localhost:8080/api/oscar";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://localhost:8080/api/oscar",
      "Локальный сервер",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:8080/api/oscar
